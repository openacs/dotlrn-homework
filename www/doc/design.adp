...
by <a href="mailto:dhogaza\@pacifier.com">Don Baccus</a><hr><h3>Introduction</h3>
...
for each homework assignment.</p><p>Administrators can ask to be notified by e-mail when a student
uploads a new homework file. Likewise, students are notified when a
comment or correction file is uploaded by a grader.</p><p>Students can only access homework files they've uploaded
themselves along with each file's associated comments and
corrections files.</p><p>Two applets and their associated portlets are provided:</p><dl>
...
</dl><p>In addition several display pages are provided to view or
...
administrator.</p><h3>Implementation</h3>
...
comment/correction files by graders.</p><p>ad_form is used to build forms in the dotLRN Homework package.
